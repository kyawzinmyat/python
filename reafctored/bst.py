...
class Bst:
		...
		def createNode(self,cur_node,node):
				cur_node.right_child=Node(node)
				cur_node.right_child.parent = cur_node
				
		def preInsertRightChild(self,cur_node,node):
			if cur_node.right_child:
				self._insert(cur_node.right_child,node)
			else:
					self.createNode(cur_node,node)
					
			
	
		
		def insertRightChild(self,cur_node,node):	
			self.preInsertRightChild(cur_node,node)
			self.setRightNodeAttr(cur_node,node)
			
			
		def setRightNodeAttr(self,cur_node,com='right'):
			self.height_change(cur_node.right_child,com)
			self.parent(cur_node.right_child)
						
		
							
		def preInsertLeftChild(self,cur_node,node):
		...
		def insertLeftChild(self,cur_node,node):	
			self.preInsertLeftChild(cur_node,node)
			self.setLeftNodeAttr(cur_node,node)
			
			
		def setLeftNodeAttr(self,cur_node,com='left'):
		...
		def _insert(self,cur_node,node):
				if node >= cur_node.value:
					self.insertRightChild(cur_node,node)						
				else:
					self.insertLeftChild(cur_node,node)
